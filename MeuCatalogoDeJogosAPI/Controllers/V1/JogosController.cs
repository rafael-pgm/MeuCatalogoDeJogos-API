using MeuCatalogoDeJogosAPI.Exceptions;
using MeuCatalogoDeJogosAPI.InputModel;
using MeuCatalogoDeJogosAPI.Services;
using MeuCatalogoDeJogosAPI.ViewModel;
...
namespace MeuCatalogoDeJogosAPI.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        //Aqui temos o get da totalidade da lista
        [HttpGet]
        ...
        //Aqui temos o get por id, que fará parte da rota
        [HttpGet("{idJogo:guid}")]
